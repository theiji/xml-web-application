<%@ Page Title="Validar Arquivo SIB" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ValidaSib.aspx.cs" Inherits="XmlApplication.App.SIB.ValidaSib" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <div class="input-group lg-3">
            <button class="btn btn-success btn-lg btn-block" runat="server" onserverclick="BtnValidaSib_Click">
